...
<body>
	...
	<div id="wrapper">
		...
		<div id="fix_menu">
			<div id="category">
				<ul class="navi">
					<li><a href="/arm/catlist?categoryno=100">손</a> <!-- 100 -->
						<ul>
