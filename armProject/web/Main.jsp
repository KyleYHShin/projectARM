...
<body>
	...
	<div id="wrapper">
		...
		<div id="fix_menu">
			...
			<div id="sort">
				<a href="#">인기도순</a>&nbsp;&nbsp; <a href="#">가격높은순</a>&nbsp;&nbsp; <a
					href="#">가격낮은순</a>&nbsp;&nbsp;
			</div>
			<!-- sort -->
		...
		<div class="contents">
			<section class="item_box">
				...
				<a href="/arm/item/ItemDetail.jsp"><table>
						<tr>
							<td class="item_img"><img src="items/01.jpg">
							<td>
						</tr>
						<tr>
							<td class="item_name">아이템 이름1
							<td>
						</tr>
						<tr>
							<td class="item_price">Price1
							<td>
						</tr>
					</table></a>
			</section>
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/02.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름2
						<td>
					</tr>
					<tr>
						<td class="item_price">Price2
						<td>
					</tr>
				</table>
			</section>
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/03.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름3
						<td>
					</tr>
					<tr>
						<td class="item_price">Price3
						<td>
					</tr>
				</table>
			</section>
			...
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/04.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름4
						<td>
					</tr>
					<tr>
						<td class="item_price">Price4
						<td>
					</tr>
				</table>
			</section>
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/05.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름5
						<td>
					</tr>
					<tr>
						<td class="item_price">Price5
						<td>
					</tr>
				</table>
			</section>
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/06.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름6
						<td>
					</tr>
					<tr>
						<td class="item_price">Price6
						<td>
					</tr>
				</table>
			</section>
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/07.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름7
						<td>
					</tr>
					<tr>
						<td class="item_price">Price7
						<td>
					</tr>
				</table>
			</section>
			<section class="item_box"">
				<table>
					<tr>
						<td><img src="items/08.jpg">
						<td>
					</tr>
					<tr>
						<td class="item_name">아이템 이름8
						<td>
					</tr>
					<tr>
						<td class="item_price">Price8
						<td>
					</tr>
				</table>
			</section>
