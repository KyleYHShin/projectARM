		...
		<div id="contents">
			...
			<div class="bill">
				...
				<table class="bill_first">
					<tr>
						<th>주문번호</th>
						<td><%=p.getPurchase_no()%></td>
					</tr>

					<tr>
						<th>성 &nbsp; 명</th>
						<td>[<%=p.getGrade_name()%>]&nbsp;<%=p.getM_name()%></td>
					</tr>
				...
				<table class="bill_third">
					...
					<tr>
						<td>총 주문금액&nbsp; <span><%=p.getDelivery() + p.getPurchase_price()%>원</span>
						</td>
					</tr>
				</table>
				...
				<table class="bill_pay">
					...
					<tr>
						<th>결제사</th>
						<td><%=pay.getPayment_company()%></td>
					</tr>
					<tr>
						<th>결제금액</th>
						<td><%=pay.getPayment_price()%></td>
					</tr>
					<tr>
						<th>결제일시</th>
