<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="member.model.vo.User, member.model.vo.Member, java.sql.Date"%>
<%
		...
		<div id="cs_menu">
			<ul class="cs_navi">
				...
				<li><a href="/arm/mypage/MyinfoQuestion.jsp" id="qa_btn">문의
						내역</a></li>
				<li><a href="../myinfo?userid=<%=loginUser.getUserId()%>"
					id="u_btn">회원정보</a></li>
			</ul>
		</div>
		<!-- cs_menu -->
		<div id="contents">
			...
			<form action="/arm/mupdate" method="post">
				<table id="infoTb" border="1" align="center">
					...
					<tr>
						<th>비밀번호</th>
						<td><input type="password" id="userpwd1" name="password"
							required></td>
					</tr>
					<tr>
						<th>비밀번호확인</th>
						<td><input type="password" id="userpwd2" name="password1"
							required> <span id="ckpwd"></span></td>
					</tr>
					<tr>
						<th>생&nbsp; &nbsp; 일</th>
 ...
 %> <input type="button"
					...
					<tr>
						...
						<td><input type="text" id="address" name="address"
							value="<%=address[0]%>" size="45"></td>
					</tr>
					<tr>
						<td><input type="text" id="address2" name="address2"
							value="<%=address[1]%>" size="45"></td>
					</tr>
					<%
						} else {
					%>
					...
					<tr>
						<td colspan="2"><a
							href="mdel?userid=<%=member.getUserId()%>">탈퇴하기</a> <input
